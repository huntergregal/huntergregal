...
function green(text) {
    return hexcolor("#44D544", text);
}
function blue(text) {
    return hexcolor("#041fa7", text);
}
function cyan(text) {
    return hexcolor("#00ffe8", text);
}
function red(text) {
...
var App = {
    ...
    blog: function () {
        ...
        setTimeout(function () {
            document.location.href = 'http://blog.huntergregal.com';
        }, 1000);
    },
    ...
    donate: function () {
        this.echo("\nBitcoin (BTC) - 3JpTRwpCkhvCE5erhyhr69UeXEewUEshQ4\n");
        this.echo("Ethereum (ETH) - 0xe587B22C61706Dc612561BB5b9f6736dCFF95F77\n");
    ...
    www: function () {
        this.echo("This page built with <a href='http://terminal.jcubic.pl/' target='_blank'>jQuery Terminal Emulator</a> plugin, and hosted by <a href='http://pages.github.com' target='_blank'>GitHub Pages<a/>.", {
            raw: true
        });
    ...
    oldsite: function () {
        ...
        setTimeout(function () {
            document.location.href = 'http://huntergregal.com/oldsite';
        }, 1000);
        if (ga != undefined) ga('send', 'event', 'env');
    },
    github: function () {
        ...
        setTimeout(function () {
            document.location.href = 'https://github.com/huntergregal';
        }, 1000);
        if (ga != undefined) ga('send', 'event', 'env');
    },
    publicPGPkey: function () {
        ...
        setTimeout(function () {
            document.location.href = 'http://huntergregal.com/publicPGPkey.txt';
        }, 1000);
        if (ga != undefined) ga('send', 'event', 'env');
    }
}
...
function showHelp(consoleObj) {
    ...
    consoleObj.echo(green("\tenv") +"               #Display environment variables");
    consoleObj.echo(green("\tgithub") +"            #Visit my github");
    consoleObj.echo(green("\thelp") +"              #This help message");
    consoleObj.echo(green("\tid") +"                #Id...");
    consoleObj.echo(green("\tls") +"                #Ls...");
    consoleObj.echo(green("\toldsite") +"           #Visit my old website");
    consoleObj.echo(green("\tpublicPGPkey") +"      #Display my public PGP key");
    consoleObj.echo(green("\tshutdown") +"          #Shutdown system");
    consoleObj.echo(green("\twhoami") +"            #Whomai...");
    consoleObj.echo(green("\twww") +"               #Display information about this site");
}